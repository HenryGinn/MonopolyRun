...
\usepackage[a4paper, top=25.4mm, bottom=25.4mm, left=19.1mm, right=19.1mm, footskip=8mm, headheight=13.6pt]{geometry}
	...
	\begin{subfigure}{#3\textwidth}
		...
		\begin{tikzpicture}
			\begin{axis}[
				...
				col sep=space,
				header=false,
				] {../Output/2026/PlottingEdges/#1.csv};
				...
				y=Y,
				col sep=comma,
				] {../Output/2026/PlottingPlaces/#1.csv};
...
\definecolor{periwinkle}{HTML}{6a7abf}
\definecolor{thistle}{HTML}{de84bf}
