...
There are additional rules that encompass the ``paying rent" part of Monopoly. Since this relies on what other teams do and I cannot remember those rules, this aspect of the Monopoly Run is considered out of scope. The goal instead will be to find routes that achieve the maxium number of points only from visiting places.
